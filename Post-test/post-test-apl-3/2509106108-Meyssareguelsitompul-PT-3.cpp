...
void cariData(Photobox data[], int jumlah, int id){

    for(int i=0;i<jumlah;i++){
        if(data[i].id==id){
            cout << "Data ditemukan : " << data[i].nama << endl;
            return;
        }
    }
...
void cariData(Photobox data[], int jumlah, string nama){

    for(int i=0;i<jumlah;i++){
        if(data[i].nama==nama){
            cout << "Data ditemukan ID : " << data[i].id << endl;
            return;
        }
    }
